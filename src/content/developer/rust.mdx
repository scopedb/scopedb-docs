...
relatedContents:
    ...
    - title: Rust SDK repository
      url: https://github.com/scopedb/scopedb-client
---
...
- Review the [Rust SDK repository](https://github.com/scopedb/scopedb-client)
  for its current examples and package API.

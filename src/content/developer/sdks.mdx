...
| --- | --- | --- |
| Node.js 20 or later, Bun, or Cloudflare Workers | [`scopedb`](https://www.npmjs.com/package/scopedb) | [Node.js SDK](/developer/nodejs) |
| Go 1.24 or later | [`github.com/scopedb/goscopedb`](https://pkg.go.dev/github.com/scopedb/goscopedb) | [Go SDK](/developer/go) |

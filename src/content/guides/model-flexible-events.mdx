...
The examples use events, but ScopeDB does not require an event schema or a time
column. Apply the same typed-versus-flexible decision to your own data model.

...
### [Storage architecture](/guides/storage-architecture)

Understand how columnar storage, clustering, and index pruning reduce the work
required by event analytics queries.
...
- understand how storage layout and pruning reduce query work with [Storage architecture](/guides/storage-architecture);

...
The syntax of a semi-structured literal is similar to the [RFC 8259 JSON format](https://datatracker.ietf.org/doc/html/rfc8259), with additions that values can be any ScopeDB data type:

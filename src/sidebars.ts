...
export const guidesSidebar: SidebarItem[] = [
    ...
    },
    {
        label: "Work with data", items: [
            ...
            { label: "Storage architecture", link: "/guides/storage-architecture" },
        ...
        label: "Functions", items: [
            ...
            },
            {
                label: "String", items: [
                    ...
                    { label: "String slicing", link: "/reference/functions/string/substr" },
            ...
            },
            {
                label: "Semi-structured data", items: [
                    ...
                    { label: "Array slicing", link: "/reference/functions/semi-structured-data/slice" },
